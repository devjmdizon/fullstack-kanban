...
function HeaderDropDown({ setOpenDropdown, setIsBoardModalOpen }) {
  ...
  return (
    ...
    >
      ...
      <div className=" bg-white dark:bg-[#001C40] shadow-md shadow-[#364e7e1a]  w-full   py-4 rounded-xl">
        ...
        <div className=" dropdown-borad  ">
          ...
          <div
            ...
            className=" flex items-baseline space-x-2  text-[#1857C3] px-5 py-4  "
          >
            <img src={boardIcon} className="   filter-white  h-4 " />
            <p className=" text-lg font-bold  ">Create New Board </p>
          </div>

          <div className=" mx-2  p-4  space-x-2 bg-slate-100 dark:bg-[#183153] flex justify-center items-center rounded-lg">
